...
;	 ASSIGN.SAL
;
; REVISION HISTORY: AN000 - Version GSO0: PARSER, System Message Handler,
;					  Status report
;
; COPYRIGHT: "GSO DOS ASSIGN Utility"
;	     "Version GSO0 (C)Copyright 1988 GSO"
;	     "Licensed Material - Program Property of GSO"
;
;
;	AN000	->		New Code
;
...
int_GSO EQU	2AH			;critical section maintenance
...
EnterAssign:				;NS- make sure system intact by doing
	...
	INT	INT_GSO 		;(2AH) NS- to screen out successfully
...
LeaveAssign:				;NS- restore re-entrancy to
	...
	INT	INT_GSO 		;(2AH) NS- made or the error recovery
...
LeaveAllAssign: 			;NS- Error recovery call
	...
	int	INT_GSO 		;(2AH) NS- if ASSIGN has encountered
