...
;			  PRINTF USED PRIOR TO VERSION GSO0.  PRINTS MESSAGES.
;
...
; REVISION HISTORY:
;
;	AN000	VERSION DOS GSO0 - IMPLEMENTATION OF MESSAGE RETRIEVER
;
; COPYRIGHT: "GSO-DOS EDLIN UTILITY"
;	     "VERSION GSO0 (C) COPYRIGHT 1988 GSO"
;	     "LICENSED MATERIAL - PROPERTY OF GSO-DOS"
;
; GSO REVISION HISTORY
;
;	 MODIFIED BY: AARON R
;		      M.A. U
;		      N. P
...
;	  releases prior to GSO0.  printf invokes the macro disp_message
