...
;	 fastopen.asm.
;
; REVISION HISTORY: A000 Version GSO0: add PARSER, System Message Handler,
;
; COPYRIGHT: "GSO-DOS FASTOPEN Utility"
;	     "Version GSO0 (C)Copyright 1988 GSO-DOS"
;	     "Licensed Material - Property of GSO-DOS"
;
;PROGRAM AUTHOR: DOS GSO0 P L
;
