...
;*
;*   STATUS:               Find utility, DOS Version GSO
;*
;*   SYNTAX (Command line)
;*
...
stack   segment para stack 'STACK'
        dw      (362 - 80h) +64 dup(?,?)    ;(362 - 80h)  == New - old GSO ROM
stack_top equ   $
stack   ends
