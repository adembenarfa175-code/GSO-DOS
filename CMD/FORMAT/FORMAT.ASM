...
;			if drive letter remapped. No longer GSO only
;   Rev 2.30
...
;****************************************
;Copy GSOIO.SYS, GSODOS.SYS and COMMAND.COM into data area.
...
GOTBIOS:
	...
	JNC	Found_GSODOS			;mt 12/8/86 P894
	return					;mt 12/8/86

Found_GSODOS:					;mt 12/8/86
...
foofoo	=	INSTALL_FAKE_BPB or TRACKLAYOUT_IS_GOOD
	...
	int	21H
						...
						;jb	 NTSupported			 ; 0 returned from GSOBIO
