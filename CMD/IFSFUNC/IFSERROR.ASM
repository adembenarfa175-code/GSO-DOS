...
;	A000 - Original version GSO0	MAY 1987					 ;AN000;
...
.list											 ;AN000;
											 ;AN000;
AsmVars <GSO, Installed, Debug> 							 ;AN000;
											 ;AN000;
...
IFSSEG	ENDS										 ;AN000;
											 ;AN000;
; include the rest of the segment definitions for normal GSODOS				 ;AN000;
											 ;AN000;
...
ASSUME	SS:DOSGROUP									 ;AN000;
											 ...
											 ;AN000;
											 ;AN000;
BREAK <SET_EXTERR_INFO -- Set GSODOS error info>					 ;AN000;
											 ;AN000;
;************************************************************************************	 ;AN000;
;											 ;AN000;
; SET_EXTERR_INFO									 ;AN000;
...
;	This is essentially the same routine as in GSODOS
;
; Outputs:
;	AX = extended error
;
