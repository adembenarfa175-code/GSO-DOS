...
;											 ;AN000;
; Function:										 ;AN000;
;	Put IFSFUNC swappable data area info in GSOdos's swap_area_table
;											 ;AN000;
; Outputs:										 ;AN000;
;	swap_area_table filled in:							 ;AN000;
;			dw	num areas - 3						 ;AN000;
;			dd	GSOdos swap indos area address
;			dw	GSOdos swap indos area length
;			dd	GSOdos swap always area address
;			dw	GSOdos swap always area length
