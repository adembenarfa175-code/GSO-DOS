	Title	Share_1 -  GSO CONFIDENTIAL
;				   $SALUT (0,36,41,44)
				   include SHAREHDR.INC
;
;     Label: "The DOS SHARE Utility"
;	     "Version GSO0 (C) Copyright 1988 GSO"
;	     "Licenced Material - Program Property of GSO"
;
...
Share				   ENDS
; include the rest of the segment definitions for normal GSODOS
...
;   GSODOS code segment otherwise, define our own code segment
...
;		   Set_Block.  For DOS GSO0 this routine will replace Set_Block
;		   in the jump table and will make repeated calls to Set_Block
;		   in order to process 1 or more lock ranges.
;
;		   NOTE: - This is an all new interface to GSODOS
;
;  INPUT:	   (AL) = 0  - lock all
;			= 80 - lock write
...
;      WE HAVE:   (from GSODOS) 	|	  WE NEED:   (for Set_Block)
...
;		   using Clr_Block.  For DOS GSO0 this routine will replace
...
;      WE HAVE:   (from GSODOS) 	|	  WE NEED:   (for Clr_Block)
