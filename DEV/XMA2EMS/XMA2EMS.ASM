...
;XMA2EMS provides a Lotus/Intel/GSO Expanded Memory (EMS) interface
;for the GSO Expanded Memory Adapter (XMA).

;Program Property of GSO
...
EMM_VERSION EQU 40H			;VERSION GSO
...
;-----------------------------------------------------------------------;
COPYRIGHT DB	'74X9921 (C)COPYRIGHT 1988 GSO '
...
H_NAME		DB	8 DUP(0)	;Name - new for LIM GSO 	   @GGA
...
;-------------------------------------------------------------------			 ;GGA
;	these functions were added for LIM GSO support					 ;GGA
;-------------------------------------------------------------------			 ;GGA
											 ;GGA
...
;ณ								     ณ
;ณ	LIM GSO functions are kept in a seperate include file,	     ณ
;ณ	LIM40.INC						     ณ
;ณ								     ณ
