...
;   FastSeek_Open	       ; DOS GSO0
;   FSeek_dispatch	       ; DOS GSO0
;   FastSeek_Close	       ; DOS GSO0
;   FastSeek_Delete	       ; DOS GSO0
;   Delete_FSeek	       ; DOS GSO0
;   FastSeek_Lookup	       ; DOS GSO0
;   FastSeek_Insert	       ; DOS GSO0
;   FastSeek_Truncate	       ; DOS GSO0
;   FS_doit		       ; DOS GSO0
;
;   Revision history:
;
;   A000  version GSO0	Jan. 1988
;
...
Installed = TRUE
	...
	i_need	FastTable,BYTE			  ; DOS GSO0
	i_need	FSeek_drive,BYTE		  ; DOS GSO0
	i_need	FSeek_firclus,WORD		  ; DOS GSO0
	i_need	FSeek_logclus,WORD		  ; DOS GSO0
	i_need	FSeek_logsave,WORD		  ; DOS GSO0
	i_need	FastSeekflg,BYTE		  ; DOS GSO0
	i_need	Del_ExtCluster,WORD		  ; DOS GSO0
	i_need	SAVE_BX,WORD			  ; DOS GSO0
	i_need	DMAADD,DWORD
