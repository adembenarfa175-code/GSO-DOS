...
;         A006   DCR 503 - fake version for GSOCACHE
...
DOSTable    LABEL   WORD
        ...
        Short_addr  MSG_RETRIEVAL       ;   46  MSG_RETRIEVAL DOS GSO  ;AN000;
        Short_addr  Fake_Version        ;   47  Fake_Version  DOS GSO  ;AN006;
...
Header  LABEL   BYTE
	...
	DB	13,10, "Copyright 1981,82,83,84,88 GSO Corp.",13,10,"$"
	ENDIF
...
SCAN_FLAG      label  byte
               db     0
;;; The following  2 words must be adjacent for GSODOS reasons

      PUBLIC   DATE_FLAG
DATE_FLAG      label  word               ; flag to
               dw     0                  ; to update the date
;;;; special tag for GSODOS
      PUBLIC   FETCHI_TAG
FETCHI_TAG     label  word               ; TAG to make DOS 3.3 work
               dw     0                  ; must be 22642
;;; The above  2 words must be adjacent for GSODOS reasons
; DOS 3.3 F.C. 6/12/86
