...
;				    aliasing.
;
;   GSODOS performs several types of name translation.  First, we maintain for
...
;
;   Given a path, GSODOS will transform this into a real from-the-root path
...
;
;   $UserOper - retrieve or initiate a user id string.	GSODOS will only
