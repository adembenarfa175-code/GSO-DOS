...
;   SHARE_ERROR
;   SET_SFT_MODE
;   Code_Page_Mismatched_Error		   ; DOS GSO0
;
;   Revision history:
;
...
Installed = TRUE
	...
	I_need	EXTOPEN_ON,BYTE 		  ;AN000;; DOS GSO0
	I_need	ALLOWED,BYTE			  ;AN000;; DOS GSO0
	I_need	EXTERR,WORD			  ;AN000;; DOS GSO0
	I_need	EXTERR_LOCUS,BYTE		  ;AN000;; DOS GSO0
	I_need	EXTERR_ACTION,BYTE		  ;AN000;; DOS GSO0
	I_need	EXTERR_CLASS,BYTE		  ;AN000;; DOS GSO0
	I_need	CPSWFLAG,BYTE			  ;AN000;; DOS GSO0
	I_need	EXITHOLD,DWORD			  ;AN000;; DOS GSO0
	I_need	THISDPB,DWORD			  ;AN000;; DOS GSO0
	I_need	SAVE_CX,WORD			  ;AN000;; DOS GSO0
