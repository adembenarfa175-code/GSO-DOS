...
;******************************************************************************
;
;   (C) Copyright GSO Corp. 1986
;
;   Title:    MEMMD.EXE - GSO Expanded Memory Manager 386 DEBUG Driver
;
...
;	Copyright 1985 by GSO Corporation
;
...
;
;	Compatability notes:
;	1.	The GSO foreign keyboard drivers don't return
...
;		GSO's foreign keyboard drivers appear not to.
...
;
;	GSO Mach 10 Enhancement Software
;
;	Copyright 1984 by GSO Corporation
