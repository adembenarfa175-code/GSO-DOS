...
;
;	Title:	MEMM.EXE - GSO Expanded Memory Manager 386 Driver
;
...
;   on the GSO 386 machine.  MEMM uses Virtual mode and paging on
...
;   described in the Lotus-Intel-GSO (LIM) specification for expanded
;   memory.
...
;	       MEMM signature
;******************************************************************************
memmsig	db	'GSO EXPANDED MEMORY MANAGER 386'
