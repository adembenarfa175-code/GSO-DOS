	...
	page	58,132
;******************************************************************************
	title	MEMMONF - (C) Copyright GSO Corp. 1986
;******************************************************************************
;
;   (C) Copyright GSO Corp. 1986
;
;   Title:    MEMM - GSO Expanded Memory Manager 386
;
...
;******************************************************************************
;
GSODOS		equ	21h			; MS-DOS function call
...
term:
	mov	ah,9
	int	GSODOS			; display error message
;
	pop	di
	pop	dx
	pop	ax
