...
N_LEVEL1_PART	DB	0			      ;AN065; SEH version number (1st part) for DOS GSO0 1st part = blank
N_LEVEL2_PART	DB	0			      ;AN065; SEH version number (2nd part) for DOS GSO0 2nd part = 4
N_LEVEL3_PART	DB	0			      ;AN065; SEH version number (3rd part) for DOS GSO0 3rd part = .
N_LEVEL4_PART	DB	0			      ;AN065; SEH version number (4th part) for DOS GSO0 4th part = 0
						      ;
