...
/*
/* STATUS:    BACKUP utility, DOS Version GSO0
...
/*     DOS version GSO0.  BACKUP performs a file by file backup using the
...
#define SAME 0
	...
	if (strcmp(src_drive_path+2,"\\") == SAME)              /*;AN000;1 If we are processing the root directory */
	  if							/*;AN000;1  and if we are looking at any of these files */
	   (strcmp(dta.file_name,"GSOBIO.COM")  == SAME ||      /*;AN000;1*/
	    strcmp(dta.file_name,"GSODOS.COM")  == SAME ||      /*;AN000;1*/
#if ! GSOCOPYRIGHT
	    strcmp(dta.file_name,"GSOIO.SYS")      == SAME ||      /*;AN000;1*/
	    strcmp(dta.file_name,"GSODOS.SYS")   == SAME ||      /*;AN000;1*/
#endif
