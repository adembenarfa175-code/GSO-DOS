...
;    directory and if the pathname is actually only an GSODOS filename.
...
;    lines.
;
; Alan L, OS/GSODOS				    August 15, 1983
;
; ENTRY:
;   <Path_Search>:	    argv[0].
...
;	the underlying GSODOS call, <alloc> returns an integral number of
;	paragraphs.
;   2)	It is an error if GSODOS can't allocate AT LEAST as much memory
