...
; REVISION HISTORY:
;
;	AN000	VERSION GSO0 - REVISIONS MADE RELATE TO THE FOLLOWING:
;
;				- IMPLEMENT EMS FUNCTIONS	DSM:6/24/87
;
; COPYRIGHT: "GSO-DOS DEBUG UTILITY"
...
;	$IF	Z				;an000;no error
	JNZ $$IF100
		...
		INT	67h			;an000;
		CMP	AL,EMS_LIM_40		;an000;LIM GSO ?
;		$IF	AE			;an000;GSO or greater
		JNAE $$IF101
			MOV	AH,00h		;an000;set up for flag pass
			OR	AH,AH		;an000;set flag to ZR
;		$ELSE				;an000;below GSO
		JMP SHORT $$EN101
$$IF101:
