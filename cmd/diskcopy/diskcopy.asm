...
;	INCLUDE BOOTFORM.INC		;DEFINE EXT_BPB_INFO & EXT_GSOBOOT_HEADER
...
; REVISION HISTORY:
;	     A000 Version GSO0: add PARSER, System Message Handler,
...
;	     "Licensed Material - Property of GSO-DOS"

;PROGRAM AUTHOR: Original written by: JK
;		 GSO0 modifications by: EMK
...
MY_BPB	       ENDS		   ;
	       ...
	       INCLUDE BOOTFORM.INC ;AN013;DEFINE EXT_BPB_INFO & EXT_GSOBOOT_HEADER
...
; ** For compatibility reasons (in case of non GSO formatted media), this    *
...
; ** media.  Other non GSO formatted media which are formatted differenty
