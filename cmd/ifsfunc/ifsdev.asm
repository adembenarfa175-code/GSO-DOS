...
TestDot:										 ;AN000;
	...
	JMP	PathSkip								 ;AN000;
											 ;AN000;
;											 ;AN000;
; Better check for trailing :.	They are ILLEGAL (read this comment, GSO) in		 ;AN000;
;  file names.										 ;AN000;
;											 ;AN000;
FoundEnd:										 ;AN000;
...
ASSUME	DS:NOTHING,ES:NOTHING								 ;AN000;
	...
	ifsr_api_def	DEPIOCTL							 ;AN000;
											 ;AN000;
	SaveReg <ES,DI,DS,SI>			; save these for GSOdos (guessing which) ;AN011;
	MOV	CS:DEVICE_CB@_OFFSET,IFSR_DEVICE_CB@	; make sure this positioned	 ;AN000;
							; right 			 ;AN000;
