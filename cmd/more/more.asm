...
;  -------    ------	       ----	   -------
;  VGSO       RussW			   ;AN000; initial extended attr. support
;
;  VGSO       Bill L	      9/17/87	   ;AN001; DCR 201 - extended attr. enhancement
;					   ;AN002; DCR 191
...
;;;	DB	" The DOS GSO MORE Filter"       ;AC003;
...
NOTTB:
	IF	MSVER			; GSO CONTROL CHARACTER PRINT
	CMP	AL,' '
	JB	ISCNTRL
	ENDIF
