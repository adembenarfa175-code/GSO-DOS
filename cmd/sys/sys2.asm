...
;		was changed from a byte to a word in DOS GSO0.
;
;
...
;	calculate # of clusters required by GSOBIO
...
;*******************************************************************************
;
;Description: GSOBIO MUST have at lease cluster 2 as its first cluster. This
...
;******************-  END  OF PSEUDOCODE -**************************************
   ...
   mov	ax,GSOLOADSIZE			; calculate # of clusters reqd	       ;AN004;
   xor	cx,cx				;				       ;AN004;
   mov	di,cx				;				       ;AN004;
   dec	di				;				       ;AN004;
   mov	cx,[CSIZE]			;   by GSOLOAD (consecutive clusters   ;AN004;
   div	cl				;   for GSOBIO) 		       ;AN004;
   cmp	ah,0				;				       ;AN004;
;  $if	ne				;				       ;AN004;
   JE $$IF41
       inc  al				;				       ;AN004;
...
;	   $else			;				       ;AN004;
	   JMP SHORT $$EN68
$$IF68:
	       cmp  [bio_owns_it],0	; is it owned by GSOBIO ?	       ;AN004;
