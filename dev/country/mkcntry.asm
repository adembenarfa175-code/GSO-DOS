...
;		 db	 248,249,250,251,252,253,254,255
	page
la_collate	label	word			  ; new for DOS GSO, wants same as spain
;
sp_collate	label	word			   ; new for DOS GSO
		ctable	<,'COLLATE',256>
...
la850_collate	   label   word 		   ; wants same as spain
;
sp850_collate	   label   word 		   ; new for DOS GSO
		ctable	<,'COLLATE',256>
		db 000,150,151,152,153,154,155,156 ;7
		db 157,158,159,160,161,162,163,164 ;15
		db 165,166,167,168,169,170,171,172 ;23
...
;
;; sp850_ucase	   label   word - changed for GSO
;		ctable	<,'UCASE  ',128>
...
page
;
;	LA case mapping for 850, new for DOS GSO to be same as Spain
;
la850_ucase	label	word
;
;	Spain (sp) case mapping for 850, new for DOS GSO
;
