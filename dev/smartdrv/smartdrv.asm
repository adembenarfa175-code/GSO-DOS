...
;			than an GSO PC AT. /E is the default.
...
;			the same system. Mixing with GSO VDISK is NOT supported.
;
...
;	Bytes/sector MUST be GSO standard 512.
;
...
;
;	1.05	5/13/88  SUNILP
;			    fixed version checking to include dos GSO0
;
...
;
; SEE ALSO
;	GSO PC TECH REF MANUAL section on INT 1C
...
;
; SEE ALSO
;	GSO PC TECH REF MANUAL section on INT 13
;
...
ASSUME	DS:INT13CODE,ES:NOTHING,SS:NOTHING
	...
	PUSH	DI
; modification sunilp
	cmp	[u_switch],0	; we shall use ol' GSO standard for this
...
;
HEADERMES db	13,10,"GSO SMARTDrive Disk Cache v2.10",13,10,"$"
