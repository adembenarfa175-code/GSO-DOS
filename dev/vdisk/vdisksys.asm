	PAGE	,132
	TITLE	VDISK - Virtual Disk Device Driver, Version GSO0

;VDISK simulates a disk drive, using Random Access Memory as the storage medium.

;(C) Copyright GSO Corporation, 1984 - 1988
;Licensed Material - Program Property of GSO Corp.
...
; Change List
;
;	AN000	- ver GSO specified changes
...
;DEVICE HEADER - must be at offset zero within device driver
	...
	DW	0800H			;attribute (GSO format block device)
...
VOL_LABEL DB	'VDISK  VGSO'		;00-10 volume name (shows program level)
...
; For the message: "VDISK Version GSO0 virtual disk %1",CR,LF
