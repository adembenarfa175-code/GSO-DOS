...
TITLE	BUF - GSODOS buffer management
NAME	BUF
...
Installed = TRUE
	...
	i_need	ALLOWED,BYTE
	i_need	FAILERR,BYTE
	i_need	HIGH_SECTOR,WORD	     ; DOS GSO0 >32mb			;AN000;
	i_need	CurHashEntry,DWORD	     ; DOS GSO0 current Hash entry	;AN000;
	i_need	BUF_HASH_PTR,DWORD	     ; DOS GSO0 Hash table pointer	;AN000;
	i_need	BUF_HASH_COUNT,WORD	     ; DOS GSO0 Hash table entries	;AN000;
	i_need	SC_CACHE_PTR,DWORD	     ; DOS GSO0 seconadary cache table	;AN000;
	i_need	SC_CACHE_COUNT,WORD	     ; DOS GSO0 secondary cache entries	;AN000;
	i_need	BUF_EMS_MODE,BYTE	     ; DOS GSO0 EMS mode 		;AN000;
	i_need	BUF_EMS_HANDLE,WORD	     ; DOS GSO0 buffer EMS handle	;AN000;
	i_need	SC_SECTOR_SIZE,WORD	     ; DOS GSO0 sector size		;AN000;
	i_need	SC_DRIVE,BYTE		     ; DOS GSO0 drive			;AN000;
	i_need	ACT_PAGE,WORD		     ; DOS GSO0 active logical EMS page	;AN000;
	i_need	DOS34_FLAG,WORD 	     ; DOS GSO0 common flag		;AN000;
	i_need	BUF_EMS_SEG_CNT,WORD	     ; DOS GSO0 EMS seg count		;AN000;
	i_need	BUF_EMS_MAP_BUFF,BYTE	     ; DOS GSO0 EMS map buffer		;AN000;
	i_need	FIRST_BUFF_ADDR,WORD	     ; DOS GSO0 beginning of the chain	;AN000;
	i_need	BUF_EMS_PAGE_FRAME,WORD      ; DOS GSO0 EMS page frame		;AN000;
