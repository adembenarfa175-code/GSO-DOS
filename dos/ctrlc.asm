...
;	A003	PTM 3957- fake version for GSOCAHE.COM
...
.list
	...
	I_need	EXTOPEN_ON,BYTE 	      ;AN000; DOS GSO
	I_need	InterCon,BYTE		      ;AN000; DOS GSO
	I_need	DOS34_FLAG,WORD 	      ;AN000; DOS GSO
	I_need	ACT_PAGE,WORD		      ;AN000; DOS GSO
	I_need	Special_Version,WORD	      ;AN007; DOS GSO
if debug
	I_need	BugLev,WORD
	I_need	BugTyp,WORD
include bugtyp.asm
...
;
	...
	CallInstall NetResetEnvironment, multNet, 34  ;DOS GSO0 doesn't need it
