...
Installed = TRUE
	...
	i_need	ALLOWED,BYTE
	I_need	JShare,DWORD
	I_need	FSeek_drive,BYTE	  ; DOS GSO0	       ;AN000;
	I_need	FSeek_firclus,WORD	  ; DOS GSO0	       ;AN000;
	I_need	FSeek_logclus,WORD	  ; DOS GSO0	       ;AN000;
	I_need	HIGH_SECTOR,WORD	  ;F.C. >32mb	       ;AN000;
	I_need	HIGH_SECTOR_TEMP,WORD	  ;F.C. >32mb	       ;AN000;
	I_need	EXTERR,WORD			   ; DOS GSO0   ;AN000;
	I_need	EXTERR_LOCUS,BYTE		   ; DOS GSO0   ;AN000;
	I_need	EXTERR_ACTION,BYTE		   ; DOS GSO0   ;AN000;
	I_need	EXTERR_CLASS,BYTE		   ; DOS GSO0   ;AN000;
	I_need	EXITHOLD,DWORD			   ; DOS GSO0   ;AN000;
	I_need	DISK_FULL,BYTE			   ; DOS GSO0   ;AN000;
	I_need	SC_DRIVE,BYTE			   ; DOS GSO0   ;AN000;
	I_need	SC_CACHE_COUNT,WORD		   ; DOS GSO0   ;AN000;
	I_need	ThisDRV,BYTE			   ; DOS GSO0   ;AN000;
	I_need	User_In_AX,WORD 		   ; DOS GSO0   ;AN000;
	I_need	DOS34_FLAG,WORD 		   ; DOS GSO0   ;AN000;
	I_need	FIRST_BUFF_ADDR,WORD		   ; DOS GSO0   ;AN000;
...
WRITE_OK:
	...
	MOV	[FSeek_drive],AL       ; 11/5/86 DOS GSO0
