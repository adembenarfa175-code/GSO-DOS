...
;
; GSODOS allows assignment if the following standard devices:
...
; Also, GSO server 1.0 requires this also.
;
...
; end warning
	...
	I_am	CNTCFLAG,BYTE,<0>	; ^C check in dispatch disabled
					; F.C. 2/17/86
	I_am	CPSWFLAG,BYTE,<0>	; Code Page Switching Flag  DOS GSO0
