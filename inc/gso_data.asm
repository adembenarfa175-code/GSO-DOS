...
;;;StackSize   =   300h                    ; This is a "trial" change GSO hasn't
...
; NOTE: We include the decl of GSOpatch in ms-dos even though it is not needed.
;       This allows the REDIRector to work on either GSO or MS-DOS.
...
;   to include this byte.
        DB      ?
            ...
            DB      (512+80+32-(SWAP_END-GSOpatch)) DUP (?)
