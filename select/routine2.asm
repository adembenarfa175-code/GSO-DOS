...
;	P_LEVEL1_PART  = Version number (1st part).   For DOS GSO0 1st part = blank
;	P_LEVEL2_PART  = Version number (2nd part).   For DOS GSO0 2nd part = 4
;	P_LEVEL3_PART  = Version number (3rd part).   For DOS GSO0 3rd part = .
;	P_LEVEL4_PART  = Version number (4th part).   For DOS GSO0 4th part = 0
;
;   OPERATION:
...
SCAN_DISK_TABLE_ROUTINE PROC FAR							     ;AN000;
    ...
    .IF < AX BE BX >				 ;AN000;
	 ...
	 COPY_BYTE	 N_LEVEL1_PART, [SI].N_PART_LEVEL1 ;AN065;SEH 1st part of version number   For DOS GSO0 1st part = blank
	 COPY_BYTE	 N_LEVEL2_PART, [SI].N_PART_LEVEL2 ;AN065;SEH 2nd part of version number   For DOS GSO0 2nd part = 4
	 COPY_BYTE	 N_LEVEL3_PART, [SI].N_PART_LEVEL3 ;AN065;SEH 2nd part of version number   For DOS GSO0 3rd part = .
	 COPY_BYTE	 N_LEVEL4_PART, [SI].N_PART_LEVEL4 ;AN065;SEH 2nd part of version number   For DOS GSO0 4th part = 0
